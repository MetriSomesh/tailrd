...
/**
 * Google OAuth entry. Links straight to the backend's OAuth start endpoint,
 * which handles the redirect dance and sets the session cookie.
 *
 * The mark is the official Google "G" — inline SVG is the correct approach for
 * a brand logo (icon libraries do not carry brand marks).
 */
